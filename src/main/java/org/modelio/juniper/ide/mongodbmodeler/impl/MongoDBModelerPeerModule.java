...
import org.modelio.juniper.ide.mongodbmodeler.api.IMongoDBModelerPeerModule;
 ...
 *
 */
public class MongoDBModelerPeerModule implements IMongoDBModelerPeerModule {
    private MongoDBModelerModule module;
	
    private IModuleAPIConfiguration peerConfiguration;
    
	public MongoDBModelerPeerModule(MongoDBModelerModule statModuleModule, IModuleAPIConfiguration peerConfiguration) {
		super();
